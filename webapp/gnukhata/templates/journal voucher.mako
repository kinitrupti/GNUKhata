...
<html>
<head>
<title>GNUKhata-Journal voucher</title>
...
$.getJSON('http://localhost:5000/journal/getAllAccounts', function(json){
	 $("#accountname").autocomplete(json.journalacc, {
		width: 320,
		max: 4,
		highlight: false,
		multiple: true,
...
<div id="fragment-1">
%if c.flag == "n" :
<form id="voucher" method="post" action="/journal/setVoucher"> 
...
<div id="fragment-2">
<form method="post" action="/journal/getVoucher" name="edit_contra">
