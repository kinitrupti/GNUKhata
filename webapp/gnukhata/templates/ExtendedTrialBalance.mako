...
<center>
	...
	<table border="1" cellspacing="0" cellpadding="0" class="ta1">
		...
		<tr class="ro2">
			...
			<td  class="ce77"><p> OPENING BALANCE ₹</p></td>
			<td  class="ce77"><p> TOTAL DEBIT TRANSACTIONS ₹</p></td>
			<td  class="ce77"><p> TOTAL CREDIT TRANSACTIONS ₹</p></td>
			<td  class="ce77"><p> DEBIT BALANCES ₹</p></td>
			<td  class="ce77"><p> CREDIT BALANCES ₹</p></td>
		</tr>
		%for i in range(0,c.length):
			%if i%2 == 0:
				<tr class="ro2">
					...
					<td  class="ce11e">${c.trialdata[i][5]}</td>
					<td  class="ce11e">${c.trialdata[i][6]}</td>
					<td  class="ce11e">${c.trialdata[i][7]}</td>
				</tr>	
			%else:
				<tr class="ro2">
					...
					<td  class="ce11o">${c.trialdata[i][5]}</td>
					<td  class="ce11o">${c.trialdata[i][6]}</td>
					<td  class="ce11o">${c.trialdata[i][7]}</td>
				</tr>	
			%endif
		%endfor
		<tr class="ro2">
			...
			<td  class="ce5"></td>
			<td  class="ce5"></td>
			<td  class="ce13">${c.totalExtendedDr}</td>
			<td  class="ce13">${c.totalExtendedCr}</td>			
	...
	<div>
	<h3><a href=${h.url_for(controller="reports",action="printExtendedTrialBalance")} id="Print" onkeyup="keydowns(event,'index_trialbal')">Print File</a></h3>
	%if (c.tb == "gtb"):
	...
	%endif
	<!--<input type="button" id="button" onkeyup="keydowns(event,'trial_todate')" onClick='Javascript:$(".printable" ).print();' style="width:20%;" value="Print File">-->
	<br>
	<h3><a href=${h.url_for(controller="reports",action="index_trialbal")} id="trial_todate" onkeyup="keyup(event,'button')">Trial Balance For Another Period</a></h3>
	</div>
	</div>
