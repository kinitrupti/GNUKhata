...
$(document).ready(function()
{
	...
	$("#viewledger").click(function()
	{
		...
		var acc_sel = document.getElementById('accountname');
		...
		var accountname = acc_search.value;
		if (accountname == "No Account Name to Display")
		{
			alert("No Account available to display Ledger, Please Create New Account!!!");
			return false;
		}
		...
		$("#ledger").load(location.protocol+"//"+location.host+"/reports/createLedger",{ 'accountname': accountname , 'from_date': fromdate, 'to_date': todate, 'projects': projects,'with_narration':narration});
		return false;
			} //END ELSE
		} //OUTER IF ENDS
...
function projtonarr()
{
	...
	if(y[x].index==0){
		if (code==38){
			document.getElementById('with_narration').focus();
...
<script>
function checked_narration()
{
	
	narration = $('#with_narration').attr('checked');
}
</script>
...
<form id="ledger" method = "post" action="${h.url_for(controller='reports',action='createLedger')}">
				...
				<fieldset style="width: 93%;">
						<legend>Shortcut For Reports</legend>
							<p><em><b> Ctrl + Shift + A:&nbsp;&nbsp;<font color = "red">A</font>ccount Creation </b></em></p>
							  ...
							  <em><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;And <font color = "red">E</font>xpenditure Account</b></em><br><br><br><br>			
				</fieldset>
				</div>

<fieldset id="fieldset" style="width: 60%;">				

<legend><label for ="view ledger"><b> View Ledger</b></label></legend>
...
<hr width="100%" size="3">
<table border="0" id="ledgerinput_table" >
	<tr align="center">
		<div align="center"><b>Account Name:</b> &nbsp;&nbsp;<select id="accountname"  onkeyup="keydown(event,'fromdated')" name="accountname" class="Required1">
		%if c.accnames == []:
		...
		<span id= "acc_warning" style="color:Red">&nbsp;</span></div>
	</tr>
...
<br>	<div align="center">			
	...
	<tr>
	<div align="right">
		<input type="submit" name="submit" accesskey="v" id="viewledger"  onkeypress="keyup(event,'projects')"  value="View" src="/images/button.png">
	</div>
	</tr>
</table>
